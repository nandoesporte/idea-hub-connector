...
const projects: ProjectIdea[] = [
  {
    ...
    description: 'Um website moderno e responsivo para a empresa XYZ Corp, com seções sobre a empresa, serviços, portfólio e contato.',
    category: 'website',
    status: 'approved',
    priority: 'high',
    user_id: 'user123',
  ...
  },
  {
    ...
    description: 'Plataforma de e-commerce para venda de roupas e acessórios, com integração de pagamento e sistema de gestão de estoque.',
    category: 'e-commerce',
    status: 'in progress',
    priority: 'medium',
    user_id: 'user456',
  ...
  },
  {
    ...
    description: 'Aplicativo mobile para iOS e Android para entrega de comida, com geolocalização, sistema de avaliação e pagamento online.',
    category: 'mobile-app',
    status: 'pending',
    priority: 'high',
    user_id: 'user789',
